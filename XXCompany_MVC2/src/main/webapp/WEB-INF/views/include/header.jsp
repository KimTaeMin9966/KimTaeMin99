	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="/" class="logo"><!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><c:out value="${title}" /></span><!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><c:out value="${title}" /><span>
			</a>
					...
					<c:when test="${!empty member}">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<span class="hidden-xs">[<c:out value="${member.auth}" />] <c:out value="${member.username}" /></span>
							</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header">
									<img src="/resources/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
									<p>[<c:out value="${member.auth}" />] <c:out value="${member.username}" /> <small>Member since <fmt:formatDate value="${member.regdate}"  pattern="yyyy-MM-dd HH:mm" /></small></p>
								</li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
								...
								<li class="user-footer">
									<div class="pull-left"><a href="/member/profiles?username=<c:out value="${member.username}" />" class="btn btn-default btn-flat">Profile</a></div>
			...
			<c:when test="${!empty member}">
				<div class="user-panel">
					...
					<div class="pull-left info">
						<p>[<c:out value="${member.auth}" />] <c:out value="${member.username}" /></p>
