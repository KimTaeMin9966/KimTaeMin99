...
<head>
	...
	<!-- FastClick -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/bower_components/fastclick/lib/fastclick.js?version=1"></script>
	<!-- AdminLTE App -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/dist/js/adminlte.min.js?version=1"></script>
	<!-- Sparkline -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js?version=1"></script>
	<!-- jvectormap  -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js?version=1"></script>
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/plugins/jvectormap/jquery-jvectormap-world-mill-en.js?version=1"></script>
	<!-- SlimScroll -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/bower_components/jquery-slimscroll/jquery.slimscroll.min.js?version=1"></script>
	<!-- AdminLTE for demo purposes -->
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/dist/js/demo.js?version=1"></script>
	...
	<!-- jvectormap -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/bower_components/jvectormap/jquery-jvectormap.css?version=1">
	<!-- Theme style -->
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/dist/css/skins/_all-skins.min.css?version=1">
